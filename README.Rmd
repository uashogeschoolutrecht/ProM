...
## ProM installation
This tutorial explains how to install ProM (current version 6.8) on a Linux UBUNTU 18.04 Virtual Machine

## VM access
Login into your VM using the IP address and credentials obtained
You can do this using a Terminal (in RStudio, PuTTy, Win-SCP or Git Bash)
...
## Download ProM 6.8
We use curl to download the 6.8 version tar archive.
```{bash}
...
The downloads as mentioned above only contain the ProM 6.8 framework. They do not contain the ProM 6.8 packages that contain the vast majority of the plug-ins. Once the ProM 6.8 framework has been download (and installed), the packages can be installed through the ProM 6.8 Package Manager.
